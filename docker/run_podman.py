...
DOWNLOAD_DIR = '/data/database/alphafold2/db'

# Name of the AlphaFold Docker image.
docker_image_name = 'localhost/alphafold:20.04'

# Path to a directory that will store the results.
output_dir = '/data/alphafold/result/'
...
flags.DEFINE_string('gpu_devices', '1', 'Comma separated list of devices to '
